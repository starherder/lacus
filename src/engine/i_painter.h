...
namespace engine
{
	...
	public:
		...
		virtual void drawTexTile(TexTile* pTexTile, const Rect& dst, float radian=0.0f, float round = 0.0f, const Color& color = Color::White) = 0;
		...
		virtual void drawLightningData(const Color& color, const Vec2& pos, const std::vector<Vec2>& data, float thickness = 1.0f) {}
